...
public class Level_01_Register_Login_Step_By_Step extends AbstractTest{
	
	WebDriver driver;
	Select select;
	String firstName, lastName, email, companyName, password;

	@Parameters({"url","browser","ip_address","port"})
	@BeforeClass
	public void beforeClass(String url, String browserName,String ipAddres,String portNumber) {
		driver=getbrowserDriver(url, browserName, ipAddres, portNumber);
